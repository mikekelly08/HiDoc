...
class EmailUserCreateForm(forms.ModelForm):
    ...
    Includes all the required fields, plus a repeted password.
    ...
    def clean_email(self):
        ...
        """
        # Since EmailUser.email is unique, is redundant,
        # but it sets a nice error message than the ORM.
        ...
        raise forms.ValidationError(
            self.error_message['duplicate_email'],
    ...
    def clean_password2(self):
        ...
        :raise form.ValidationError: password2 != password1
    ...
    def save(self, commit=True):
        ...
        :return email_user.models.EmailUser: user
...
class EmailUserChangeForm(forms.ModelForm):
    ...
    # In Django 1.9 the url for changing the password was changed
    # A url name was also added in 1.9
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f is not None:
            f.queryset = f.queryset.select_related('country_type')
