...
class AbstractEmailUser(AbstractBaseUser, PermissionsMixin):
    """
    Abstract user with the same behavior as Django's default user.
    ...
    Inherits from both the AbstractBaseUser and Permissions Mixin.
    ...
    email = models.EmailField(_('email address'), max_lenght=255,
                              unique=True, db_index=True)
    is_staff = models.BooleanField(
        _('staff status'), default=False, help_text=_(
            'Designates wether the user can log into the admin site.'))
    is_active = models.BooleanField(_('active'), default=True, help_text=_(
        'Designates whether this user should be treated as '
        'active. Unselect this instead of deleating the acounts.'))
